...
# Note -- need to use constant expression for library location -- can't use 
# this variable
liblocation = "/home/dahlbom/research/ccarfac/carfac.o"
...
"""
	transferring memory ownership through own=false in unsafe_unwrap seemed to cause problems
	when using carfacagc_free_except_signal...
